...
public class TulonakariDeskTest {
...
private WebDriver driver = null;
	...
	public void tulonakaritest() throws InterruptedException {
		
		System.out.println("Tulonakari Test Start");
			
		Thread.sleep(3000);
		driver.findElement(By.xpath(XpathUtils.TulonaKariDeskModule.খারিজ_খতিয়ান)).click();
		
		Thread.sleep(2000);
		driver.findElement(By.xpath(XpathUtils.TulonaKariDeskModule.তুলনার_জন্য_অপেক্ষমাণ)).click();
		
		Thread.sleep(2000);
		driver.findElement(By.xpath(XpathUtils.TulonaKariDeskModule.বিস্তারিত)).click();
		
		Thread.sleep(3000);
		driver.findElement(By.xpath(XpathUtils.TulonaKariDeskModule.বিস্তারিত_close)).click();
		
		Thread.sleep(2000);
		driver.findElement(By.xpath(XpathUtils.TulonaKariDeskModule.ওপেন)).click();
		...
		while (iteration.hasNext()) {
			...
			if(!mainWindow.equalsIgnoreCase(secondWindow)) {
				...
				//start second window
				Thread.sleep(2000);
				driver.findElement(By.xpath(XpathUtils.TulonaKariDeskModule.বিস্তারিত2)).click();
				
				Thread.sleep(3000);
				driver.findElement(By.xpath(XpathUtils.TulonaKariDeskModule.বিস্তারিত2_close)).click();
				...
				Thread.sleep(3000);
				driver.findElement(By.xpath(XpathUtils.TulonaKariDeskModule.প্রেরণ)).click();
				//end second window
				driver.close();
			}
		...
		System.out.println("Tulonakari Test End");
		    
	}
	
	@Test(dependsOnMethods = "tulonakaritest")
